...
//
//            JSONObject root = new JSONObject(SAMPLE_JSON_RESPONSE);  //Convert SAMPLE_JSON_RESPONSE String into a JSONObject
//
//            JSONArray earthquakeArray=root.getJSONArray("features"); // Extract “features” JSONArray
//
//            // Loop through each feature in the array
//            for (int i=0;i<earthquakeArray.length();i++){
//                JSONObject currentEarthquake=earthquakeArray.getJSONObject(i);   // Get earthquake JSONObject at position i
//
//                JSONObject properties =currentEarthquake.getJSONObject("properties");   // Get “properties” JSONObject
//
////                String magnitude=properties.getString("mag");    // Extract “mag” for magnitude
//                // Extract the value for the key called "mag"
//                double magnitude = properties.getDouble("mag");
//
//                String place=properties.getString("place");  // Extract “place” for location
//
////                String time=properties.getString("time");    // Extract “time” for time
...
//
//                Earthquake earthquake=new Earthquake(magnitude,place,time,url); // Create Earthquake java object from magnitude, location, and time
//
//                earthquakes.add(earthquake);    // Add earthquake to list of earthquakes
//            }
